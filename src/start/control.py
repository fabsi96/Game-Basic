...
from src.control import VControl
    ...
    def mouseMoveCallback(self, mouseEvent: QMouseEvent) -> None:
        ...
        try:
            ...
            if self.mouseLeftPressed:
                ...
                rotator = rotate(tmat4x4(), deltaX * -self.MOUSE_SPEED_FREE_FLIGHT,
                                 Library.camera.getUpVector()) * \
                          rotate(tmat4x4(), deltaY * -self.MOUSE_SPEED_FREE_FLIGHT, toRotateAround)
